...
export default function LineGraph() {
  ...
  //Handling graph loading state
  if (isLoading || historicalData === undefined) {
    return (
...
const data = {
  ...
  datasets: [
    ...
    {
      label: 'Recovered',
      data: recovered.map((recovered)=>recovered),
      borderColor: 'rgb(53, 162, 235)',
      backgroundColor: 'rgba(53, 162, 235, 0.5)',
    },
    {
      label: 'Deaths',
      data: deaths.map((death)=>death),
  ...
  return (
    <div className="w-full h-3/4 xl:w-5/6 flex justify-center p-4 xl:p-6 xl:px-14">
